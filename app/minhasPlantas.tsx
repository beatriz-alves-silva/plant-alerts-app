...
const plantsData: Plant[] = [
  { id: '1', name: 'Cacto Bola', nextNotification: '26/03', imageSource: require('../assets/cacto.jpg') /* ou cactus1 */ },
  { id: '2', name: 'Suculenta Jade', nextNotification: '28/03', imageSource: require('../assets/cacto.jpg') /* ou cactus2 */ },
  { id: '3', name: 'Samambaia', nextNotification: '30/03', imageSource: require('../assets/cacto.jpg') /* ou cactus3 */ },
];
